...
class AbstractConfig extends Config(
  ...
  new chipyard.harness.WithWGSimTSIOverSerialTL ++                   // add external serial-adapter and RAM
  ...
  new chipyard.iobinders.WithWGSerialTLIOCells ++
  ...
  new worldguard.WithWGAwareInclusiveCache ++          // use Worldguard-aware L2 cache
